...
DATABASES = {
    'default': {
        ...
        'NAME': 'engin_capstone', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'engin-capstone.cinhwiupefce.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'engin-capstone-s3' # please enter your s3 bucket name
